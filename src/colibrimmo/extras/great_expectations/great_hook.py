...
class KedroGreat:
    ...
    def _run_validation(
        ...
        for dataset_name, dataset_value in data.items():
            ...
            target_suite_names = self.get_suite_names(dataset_name)
    ...
    def get_suite_names(self, dataset_name) -> List[str]:
        found_mappings = self.expectations_map.get(dataset_name, dataset_name)
